...
@section('content')
    <div class="mt-2">
        <x-form-section>
            ...
            <x-slot name="title">{{ __("Update guard") }}</x-slot>

            <x-slot name="description">
                {{ __("You can update the guard's information.") }}
            </x-slot>

            <x-slot name="form">
                <form method="POST" action="{{ route('guard.update', ['user' => $guard->id]) }}" class="grid grid-cols-6 gap-6">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="username"
                                 ...
                                 type="text"
                                 name="username"
                                 :value="old('username') ?? $guard->username"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="birthdate"
                                 ...
                                 name="birthdate"
                                 maxlength="10"
                                 :value="old('birthdate') ?? $guard->birthdate"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="personal_phone"
                                 ...
                                 name="personal_phone"
                                 maxlength="10"
                                 :value="old('personal_phone') ?? $guard->personal_phone"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="home_phone"
                                 ...
                                 name="home_phone"
                                 maxlength="9"
                                 :value="old('home_phone') ?? $guard->home_phone"
